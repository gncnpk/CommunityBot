...
namespace WazeBotDiscord.Outreach
{
    public class OutreachService
    {
        ...
        public OutreachService(HttpClient client)
        {
            _client = client;
        }
        ...
        public async Task InitAsync()
        {
            ...
            {
                _sheets = await db.OutreachSheetsToSearch.ToListAsync();
            }
        }
        ...
        {
            var existing = GetExistingOutreachSheet(channelID, guildID);
            if (existing == null)
            {
        ...
        public OutreachSheetToSearch GetExistingOutreachSheet(ulong channelId, ulong guildId)
        {
