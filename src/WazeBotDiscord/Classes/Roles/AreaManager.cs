...
namespace WazeBotDiscord.Classes.Roles
{
    public static class AreaManager
    {
        public static IReadOnlyDictionary<ulong, ulong> Ids = new Dictionary<ulong, ulong>
        {
            ...
            [360595895965843456] = 360597242408730634, // Community Test Server
            [359327158944137227] = 360619303659241492, // JustinTest server
            [356076662812573698] = 363009435452440577, // VEOC
            [352258352417603587] = 352276470951051274  // Territories
        };
    }
}
